...
describe('auth routes', () => {
  ...
  describe('GET /auth/sign-in-oidc', () => {
    ...
    test('should return unauthorised view if unauthenticated but redirected from Defra Identity', async () => {
      // This scenario will only occur if the user has completed the Defra Identity sign in process but did not start from the application
      // ie they have bookmarked the Defra Identity sign in page or have navigated directly to it
